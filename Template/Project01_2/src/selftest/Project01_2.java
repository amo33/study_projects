...
public class Project01_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(/* Print 'greeting1', 'name' and 'greeting2'. Add space each variables. */); 
		System.out.println(/* Print length of 'name' variable by using String class method. */);
		System.out.println(/* Print equality of 'name' and 'uName' variables. (Case sensitive) */);
		System.out.println(/* Print equality of 'name' and 'uName' variables. (Case insensitive) */);
	}
