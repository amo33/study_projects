...
def mostCommonWord(paragraph, banned):
    paragraph2 = paragraph.lower().replace("'","")
    info_dict = collections.Counter(list(re.split('[ |,|.|!|;|?]',paragraph2)))
    for ban in banned:
        info_dict[ban] = -1 
    print(info_dict)
    if info_dict.most_common(1)[0][0] == "":
        return info_dict.most_common(2)[1][0]
    return info_dict.most_common(1)[0][0]
