...
def open_chorme():
    ...
    chrome_driver_dir = "./chrome/chromedriver.exe"
    #driver = webdriver.Chrome(r "C:\Users\andyl\OneDrive\바탕 화면\Study\Crawler\naver_place_crawling\chromedriver.exe", chrome_options=options)
